...
insert into url(url_id, db_id, url, sid) values(6, 1, 'postgres://kuvasz:kuvasz@127.0.0.1:6017/db1?replication=database&application_name=repl_db1', '17');
...
insert into url(url_id, db_id, url, sid) values(7, 2, 'postgres://kuvasz:kuvasz@127.0.0.1:6012/db2?replication=database&application_name=repl_db2', '12');
insert into url(url_id, db_id, url, sid) values(8, 2, 'postgres://kuvasz:kuvasz@127.0.0.1:6013/db2?replication=database&application_name=repl_db2', '13');
insert into url(url_id, db_id, url, sid) values(9, 2, 'postgres://kuvasz:kuvasz@127.0.0.1:6014/db2?replication=database&application_name=repl_db2', '14');
insert into url(url_id, db_id, url, sid) values(10,2, 'postgres://kuvasz:kuvasz@127.0.0.1:6015/db2?replication=database&application_name=repl_db2', '15');
insert into url(url_id, db_id, url, sid) values(11,2, 'postgres://kuvasz:kuvasz@127.0.0.1:6016/db2?replication=database&application_name=repl_db2', '16');
insert into url(url_id, db_id, url, sid) values(12,2, 'postgres://kuvasz:kuvasz@127.0.0.1:6017/db2?replication=database&application_name=repl_db2', '17');
